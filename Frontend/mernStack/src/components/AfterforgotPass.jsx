...
const AfterforgotPass = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center gap-1 text-xs sm:text-sm text-gray-400 text-center">
        <p>Didn’t receive the email?</p>
        <p>
          Contact us at{" "}
          <Link
            className="text-violet-400 hover:text-violet-300 transition break-all"
