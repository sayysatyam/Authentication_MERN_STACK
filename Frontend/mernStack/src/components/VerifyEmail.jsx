...
useEffect(() => {
  ...
  return (
    <div
      className="w-130 min-h-fit flex flex-col items-center p-6 gap-8
    ...
    >
      <div className="flex flex-col items-center text-center gap-2">
        ...
        <h2 className="text-3xl font-bold bg-linear-to-r from-purple-400 to-violet-400 bg-clip-text text-transparent">
          Verify your Email
        </h2>
